...
func (api *API) GetActions(name AccountName, pos, offset int) (out *ActionsResp, err error) {
	err = api.call("history", "get_actions", M{"account_name": name, "pos": pos, "offset": offset}, &out)
	return
}
