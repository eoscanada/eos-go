...
func TestABI_Read(t *testing.T) {
	...
	testCases := []map[string]interface{}{
		...
		{"caseName": "public_key", "typeName": "public_key", "value": "\"PUB_K1_1111111111111111111111111111111114T1Anm\"", "encode": ecc.PublicKey{Curve: ecc.CurveK1, Content: bytes.Repeat([]byte{0}, 33)}, "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
