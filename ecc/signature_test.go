...
func TestEOSJSEquiv(t *testing.T) {
	...
	assert.Equal(t, "SIG_K1_Kk1yUXAG2Cfo2qvWuJiyvaGdwZBQ1HzSf4EZ9arUTWBL4kTngLM1GSUU59bJUVAqwJ886CNQMcR7mmx323gjQGvhEU8WpX", sig.String())
}

func TestEOSJSEquivEmptyDigest(t *testing.T) {
	// Test cases from eosjs (src/signature.test.js)
	...
	privKey, err := NewPrivateKey("5HxQKWDznancXZXm7Gr2guadK7BhK9Zs8ejDhfA9oEBM89ZaAru")
	require.NoError(t, err)
	...
	assert.Equal(t, "SIG_K1_Jz9d1rKmMV51EY6dnU3pNaDiLvGTeVdxDZGvJEfAkdcwzs97gNg5yYPhPSdEg33Jyp5736Tnnzccf1p6h6vedXpHSUBio1", sig.String())
}
