...
func TestEOSIOCSigningComparison(t *testing.T) {
	...
	payload, err := hex.DecodeString("")
	require.NoError(t, err)

	sig, err := privKey.Sign(payload)
	require.NoError(t, err)

	fromEOSIOC := "EOSKfWiDNakrdPY9uiLRc7iuk3WB7MZmWFfBCLNY7vUMke64yooUdkzqUKm1BpN3NUrRCn6w9bMUS9m3rsCfoJF5LsFoRSLi7"
	assert.Equal(t, fromEOSIOC, sig.String())
}
