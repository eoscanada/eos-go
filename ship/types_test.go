...
//
//	fmt.Printf("%+v\n", res.Block.AsSignedBlock())
//	for _, tr := range res.Traces.AsTransactionTracesV0() {
//		fmt.Printf("%+v\n", tr)
//		for _, atr := range tr.ActionTraces {
//			fmt.Printf("%+v\n", atr.Impl.(*ActionTraceV0).Receipt.Impl.(*ActionReceiptV0))
//		}
//	}
//}
//
...
func TestBlock5TransactionsTraces(t *testing.T) {
	t.Skip()
	...
	for _, t := range out {
		fmt.Println(t.Impl.(*TransactionTraceV0))
	}
